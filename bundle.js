(function () {
  ...
  1: [function (require, module, exports) {
    ...
    "axios": 2,
    "cheerio": 43,
    "cheerio/lib/api/manipulation": 40,
    "domutils": 73
  }],
    ...
    function filterParsed(selector, elements, options) {
      ...
      return typeof found !== "undefined" ?
        (found.size === elements.length ?
          elements : // Filter elements to preserve order
    ...
    function _matchUntil(nextElem) {
      ...
      var innerMatcher = _getMatcher(function (nextElem, elems) {
        ...
        utils_1.domEach(elems, function (elem) {
          for (var next_1;
            (next_1 = nextElem(elem)); elem = next_1) {
  ...
  46: [function (require, module, exports) {
    ...
    "./parsers/htmlparser2-adapter": 47,
    "./parsers/parse5-adapter": 48,
    "buffer": 33,
    "domhandler": 69,
    "htmlparser2": 90
  }],
  ...
  48: [function (require, module, exports) {
    ...
    function parse(content, options, isDocument) {
      ...
      return isDocument ?
        parse5_1.parse(content, opts) : // @ts-expect-error Same issue again.
    ...
    "domhandler": 69,
    "parse5": 109,
    "parse5-htmlparser2-tree-adapter": 95,
    "tslib": 121
  }],
  ...
  53: [function (require, module, exports) {
    ...
    "./general": 54,
    "./procedure": 56,
    "./pseudo-selectors/subselects": 61,
    "./sort": 62,
    "boolbase": 32,
    "css-what": 63
  }],
  ...
  89: [function (require, module, exports) {
    ...
    "entities/lib/decode_codepoint": 80,
    "entities/lib/maps/entities.json": 84,
    "entities/lib/maps/legacy.json": 85,
    "entities/lib/maps/xml.json": 86
  }],
  ...
  95: [function (require, module, exports) {
    ...
    "parse5/lib/common/doctype": 96,
    "parse5/lib/common/html": 99
  }],
  ...
  102: [function (require, module, exports) {
    ...
    "../../utils/mixin": 119,
    "../location-info/tokenizer-mixin": 107,
    "./mixin-base": 101,
    "./tokenizer-mixin": 104
  }],
  103: [function (require, module, exports) {
    ...
    "../../utils/mixin": 119,
    "../position-tracking/preprocessor-mixin": 108,
    "./mixin-base": 101
  }],
  ...
  111: [function (require, module, exports) {
    ...
    "../common/doctype": 96,
    "../common/error-codes": 97,
    "../common/foreign-content": 98,
    "../common/html": 99,
    "../common/unicode": 100,
    "../extensions/error-reporting/parser-mixin": 102,
    "../extensions/location-info/parser-mixin": 106,
    "../tokenizer": 114,
    "../tree-adapters/default": 117,
    "../utils/merge-options": 118,
    "../utils/mixin": 119,
    "./formatting-element-list": 110,
    "./open-element-stack": 112
  }],
